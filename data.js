...
const METHODS = [
  {
    ...
    flavorText:"想<b>輕鬆無腦</b>沖一杯平衡好咖啡。良好的醇厚度與質地、清脆明亮的酸質，乾淨無雜味。",
  ...
  },
  {
    ...
    flavorText:"想要<b>乾淨度極高</b>、雜味少、入口香氣強烈飽滿、尾韻滑順。百搭且保證好喝的高容錯率配方。",
  ...
  },
  {
    ...
    flavorText:"想品嚐<b>極致的產地風味</b>：前中後段風味明確、柔和甜味、飽滿果汁感與悠長尾韻。",
  ...
  },
  {
    ...
    flavorText:"追求顛覆想像的<b>糖漿 / 果凍般濃稠質地</b>與極致甜感。大幅降低酸的刺激，換取豐滿正面風味。",
